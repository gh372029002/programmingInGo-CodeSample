...
func main() {
	xs := []int{2, 4, 6, 8}
	fmt.Println("Index=5 @", Index(xs, 5), "  Index=6 @", Index(xs, 6))
	ys := []string{"C", "B", "K", "A"}
	fmt.Println("Index=Z @", Index(ys, "Z"), "  Index=A @", Index(ys, "A"))

	fmt.Println("IndexReflectX=5 @", IndexReflectX(xs, 5), "  IndexReflectX=6 @", IndexReflectX(xs, 6))
	fmt.Println("IndexReflectX=Z @", IndexReflectX(ys, "Z"), "  IndexReflectX=A @",
		IndexReflectX(ys, "A"))
	fmt.Println("IndexReflect=5 @", IndexReflect(xs, 5), "  IndexReflect=6 @", IndexReflect(xs, 6))
	fmt.Println("IndexReflect=Z @", IndexReflect(ys, "Z"), "  IndexReflect=A @",
		IndexReflect(ys, "A"))

	fmt.Println("IntIndexSlicer=5 @", IntIndexSlicer(xs, 5),
		"  IntIndexSlicer=6 @", IntIndexSlicer(xs, 6))
	fmt.Println("IntIndexSlicer=Z @", StringIndexSlicer(ys, "Z"),
		"  IntIndexSlicer=A @", StringIndexSlicer(ys, "A"))
